...
<div class="container body">
    <div class="main_container">
        ...
        <div class="right_col" role="main">
            <div class="container">
                <center><h3>添加武器页面</h3></center>
                <form action="${pageContext.request.contextPath}/addWeaponServlet" method="post">
                    <div class="form-group">
                        <label for="name">武器名称：</label>
                        <input type="text" class="form-control" id="name" name="name" placeholder="请输入武器名称">
                    </div>


                    <div class="form-group">
                        <label for="u_id">维护人员编号：</label>
                        <input type="text" class="form-control" id="u_id" name="u_id" placeholder="请输入维护人员编号">
                    </div>

                    <div class="form-group">
                        <label for="wh_id">仓库编号：</label>
                        <input  type="text" name="wh_id" class="form-control" id="wh_id" placeholder="请输入仓库编号"></input>
                    </div>

                    <div class="form-group">
                        <%--@declare id="range"--%><label for="range">射程：</label>
                        <input type="text" class="form-control" id="range" name="range" placeholder="请输入射程"/>
                    </div>
