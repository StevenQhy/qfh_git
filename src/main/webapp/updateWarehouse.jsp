        ...
        <div class="right_col" role="main">
            <div class="container" style="width: 400px;">
                ...
                <form action="${pageContext.request.contextPath}/updateWareHouseServlet" method="post">
                    ...
                    <input type="hidden" name="id" value="${warehouse.ware_id}">
                    <div class="form-group">
                        <label for="name">仓库名称：</label>
                        <input value="${warehouse.name}" type="text" class="form-control" id="name" name="name"   placeholder="请输入仓库名称" />
                    </div>


                    <div class="form-group">
                        <label for="address">地址：</label>
                        <input value="${warehouse.address}" type="text" class="form-control" id="address"  name="address" placeholder="请输入仓库地址" />
                    </div>
